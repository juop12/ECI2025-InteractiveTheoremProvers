...
(* Theorem: If a type has homotopy level n, then it has homotopy level n+1.*)
...
Theorem hlevels_are_cumulative  {n : nat} {T : UU} (h : isofhlevel n T) : isofhlevel (S n) T.
Proof.
    apply hlevel_cumulative_ind.
    exact h.
Defined.
